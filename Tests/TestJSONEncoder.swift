...
class TestMetaSerializationByJSONEncoderTests : XCTestCase {
    ...
    let emptyContainer = Data(bytes: [0x80])
    ...
    func testEncodingTopLevelStructuredClass() {
        ...
        let expectedContainer = Data(bytes: [0x82, 0xa4, 0x6e, 0x61, 0x6d, 0x65, 0xb0, 0x4a,  0x6f, 0x68, 0x6e, 0x6e, 0x79, 0x20, 0x41, 0x70, 0x70, 0x6c, 0x65, 0x73, 0x65, 0x65, 0x64, 0xa5,  0x65, 0x6d, 0x61, 0x69, 0x6c, 0xb3, 0x61, 0x70, 0x70, 0x6c, 0x65, 0x73, 0x65, 0x65, 0x64, 0x40,  0x61, 0x70, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d,])
    ...
    func testEncodingTopLevelNullableType() {
        ...
        _testRoundTrip(of: EnhancedBool.true, expected: Data(bytes: [0xc3]) )
        _testRoundTrip(of: EnhancedBool.false, expected: Data(bytes: [0xc2]) )
        _testRoundTrip(of: EnhancedBool.fileNotFound, expected: Data(bytes: [0xc0]) )
        
        _testRoundTrip(of: TopLevelWrapper(EnhancedBool.true), expected: Data(bytes: [0x81, 0xa5, 0x76, 0x61, 0x6c, 0x75, 0x65, 0xc3]) )
        _testRoundTrip(of: TopLevelWrapper(EnhancedBool.false), expected: Data(bytes: [0x81, 0xa5, 0x76, 0x61, 0x6c, 0x75, 0x65, 0xc2]) )
        _testRoundTrip(of: TopLevelWrapper(EnhancedBool.fileNotFound), expected: Data(bytes: [0x81, 0xa5, 0x76, 0x61, 0x6c, 0x75, 0x65, 0xc0]) )
    }
    ...
    func testDecoderStateThrowOnDecode() {
        ...
        let container = Data(bytes: [0x93, 0x01, 0x02, 0x03,])
